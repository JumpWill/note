...
fn main() {
    ...
    println!("矩形宽: {}", rect.width);
    println!("矩形高: {}", rect.height);
    println!("矩形面积: {} 平方单位", area(&rect));
}
